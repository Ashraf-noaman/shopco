  ...
  return (
    <div className="group cursor-pointer relative">
      <div className="bg-[#f0eeed] dark:bg-secondary rounded-2xl overflow-hidden aspect-[3/4] flex items-center justify-center mb-3 relative">
        <div
          className="w-4/5 h-4/5 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-300"
        ...
        >
          <div
            className={`absolute inset-0 flex items-end justify-center pb-4 transition-opacity duration-200 ${added ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}
          >
            <span
              onClick={handleAddToCart}
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold shadow-lg transition-all ${added ? "bg-green-600 text-white" : "bg-foreground text-background"}`}
            >
